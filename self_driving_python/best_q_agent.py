...
#def run(alpha=decay4, gamma=0.4, epsilon=cross_entropy, initial_value='zero', sim_num=1):
#def run(alpha=decay3, gamma=0.1, epsilon=constant, initial_value='zero', sim_num=1):
def run(alpha=decay2, gamma=0.6, epsilon=arithmetic_average, initial_value='zero', sim_num=1):
...
if __name__ == '__main__':
    ...
    path = os.path.join(script_dir, '../results/best_q_agent4.json')
    run()
